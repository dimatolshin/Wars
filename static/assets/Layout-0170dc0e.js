...
`,D=16,As=({reverseOrder:t,position:e="top-center",toastOptions:s,gutter:a,children:o,containerStyle:r,containerClassName:n})=>{let{toasts:i,handlers:l}=Le(s);return c.createElement("div",{style:{position:"fixed",zIndex:9999,top:D,left:D,right:D,bottom:D,pointerEvents:"none",...r},className:n,onMouseEnter:l.startPause,onMouseLeave:l.endPause},i.map(d=>{let p=d.position||e,g=l.calculateOffset(d,{reverseOrder:t,gutter:a,defaultPosition:e}),f=gs(p,g);return c.createElement(fs,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?hs:"",style:f},d.type==="custom"?Z(d.message,d):o?o(d):c.createElement(ms,{toast:d,position:p}))}))},ys=x;function xs(){const t=Tt(),e=it(qt),{tg_id:s,userName:a}=Pt(),[o,r]=c.useState(!1),n=ot({queryFn:()=>le(s,a),queryKey:["info",s],enabled:!!s,retry:1},S);c.useEffect(()=>{n.data&&r(!0),t(ct.addCoinStore(n.data))},[n.data]);const i=ot({queryFn:()=>de(s),queryKey:["army",s],enabled:!!s&&o,retry:2},S);c.useEffect(()=>{t(ne.addArmyStore(i.data))},[i.data]);const d=new URLSearchParams(zt().search).get("id"),[p,g]=c.useState(),f=ot({queryKey:["friend"],queryFn:()=>ue(s,p),enabled:!!s&&!!p,retry:1},S);return c.useEffect(()=>{d&&g(d)},[d]),c.useEffect(()=>{f.data&&ys.success(f.data)},[f.data]),u.jsxs("div",{className:y.coinBlock,children:[u.jsxs("p",{className:y.descrLvl,children:["LVL ",e==null?void 0:e.lvl]}),u.jsxs("div",{className:y.coinBar,children:[u.jsxs("div",{className:y.coinBlockMoney,children:[u.jsx("img",{className:y.imgCoin,src:Ce,alt:""}),u.jsx("div",{className:y.bgValue,children:u.jsx("p",{className:y.descr,children:e==null?void 0:e.money.toLocaleString("ru-RU")})}),u.jsx(wt,{className:y.btnDonatMoney,children:u.jsx("img",{src:Rt,alt:""})})]}),u.jsxs("div",{className:y.coinBlockMoney,children:[u.jsx("img",{className:y.imgCoin,src:Be,alt:""}),u.jsx("div",{className:y.bgValue,children:u.jsx("p",{className:y.descr,children:"0"})}),u.jsx(wt,{className:y.btnDonatMoney,children:u.jsx("img",{src:Rt,alt:""})})]})]})]})}const bs="_list_138vi_1",vs="_item_138vi_11",ks="_link_138vi_21",ws="_img_138vi_26",Rs="_descr_138vi_31",Es="_active_138vi_39",j={list:bs,item:vs,link:ks,img:ws,descr:Rs,active:Es},Cs="/assets/guilds-a9a43f6c.png",Bs="/assets/friends-205bb587.png",js="/assets/attack-1b400151.png",Ms="/assets/leaders-4fe79ef5.png",Ns="/assets/airdrop-f8a7acac.png",Is=[{text:"Guilds",path:"/guilds",img:Cs},{text:"Friends",path:"/friends",img:Bs},{text:"Attack!",path:"/",img:js},{text:"Leaders",path:"/leaders",img:Ms},{text:"Airdrop",path:"/airdrop",img:Ns}];function Os(){const t=zt();return u.jsx("ul",{className:j.list,children:Is.map(e=>u.jsx("li",{className:t.pathname===e.path?`${j.item} ${j.active}`:j.item,children:u.jsx(St,{to:e.path,children:u.jsxs("div",{className:j.link,children:[u.jsx("img",{className:j.img,src:e.img,alt:e.text}),u.jsx("p",{className:j.descr,children:e.text})]})})},e.path))})}/*! *****************************************************************************
